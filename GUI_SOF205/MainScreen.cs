...
namespace GUI_SOF205
{
    public partial class MainScreen : Form
    {
        ...
        private void btnQLPhieuBanHang_Click(object sender, EventArgs e)
        {
            ShowFormInPanel(new QuanLyPhieuBanHang());
        }
        ...
        private void itmGioiThieu_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start(new ProcessStartInfo
                {
                    FileName = "https://caodang.fpt.edu.vn/",
        ...
        private void itmTroGiup_Click(object sender, EventArgs e)
        {
            ShowFormInPanel(new TroGiup());
        }

        private void itmQLTheLuuDong_Click(object sender, EventArgs e)
        {
            ShowFormInPanel(new QuanLyTheLuuDong());
        }
    }
}
